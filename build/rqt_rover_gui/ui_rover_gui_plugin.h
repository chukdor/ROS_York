...
public:
    ...
    QRadioButton *all_autonomous_control_radio_button;
...
""));
        ...
        autonomous_control_radio_button->setGeometry(QRect(10, 60, 171, 22));
        ...
        joystick_control_radio_button->setGeometry(QRect(10, 30, 117, 22));
        ...
        all_autonomous_control_radio_button = new QRadioButton(control_group_box);
        rover_control_button_group->addButton(all_autonomous_control_radio_button);
        all_autonomous_control_radio_button->setObjectName(QString::fromUtf8("all_autonomous_control_radio_button"));
        all_autonomous_control_radio_button->setEnabled(false);
        all_autonomous_control_radio_button->setGeometry(QRect(10, 90, 151, 22));
        all_autonomous_control_radio_button->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QWidget *RoverGUI)
    {
        ...
        all_autonomous_control_radio_button->setText(QApplication::translate("RoverGUI", "All Autonomous", 0, QApplication::UnicodeUTF8));
